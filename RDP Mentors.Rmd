...
Faculty Advisor: Angela Urick (2018-2020) Jennifer Clayton (2019-2021), Stephen Kotok (2020-2022)

---
# Locations of RDP Mentors

This map is shows some of the locations of current and former RDP mentors. If you click on the markers, you will see which institution is represented. 
```{r}
df %>% 
leaflet() %>%
